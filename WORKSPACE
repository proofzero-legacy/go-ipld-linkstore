...
go_repository(
    ...
    sum = "h1:lohp5blsw53GBXtLyLNaTXPXS9pJ1tiTw61ZHUoE9Qw=",
...
go_repository(
    ...
    sum = "h1:SS1t869a6cctoSYmZXUk8eL6AzVXgASmKIWFNQkQ1jU=",
    version = "v0.3.1",
)
...
go_repository(
    ...
    sum = "h1:V1GZorHFUIB6YgTJQdq7mcaIpUfCM3fCyVi+MTo9O88=",
    version = "v0.1.0",
)
